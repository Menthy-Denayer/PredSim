...
S.subject.TrackingFileKinematics = fullfile(S.misc.main_path,'Tests','vanCriekinge_referenceCoordinates.mot'); % mot file used for tracking 
...
S.subject.TrackingFileGRF = fullfile(S.misc.main_path,'Tests','vanCriekinge_referenceGRF.sto'); % sto file used for tracking 
S.subject.TrackingGRFs = {'ground_force_r_vx', 'ground_force_r_vy', 'ground_force_l_vx', 'ground_force_l_vy'};
S.weights.grfTracking = 1;
...
Qref_tot = getIK(S.subject.TrackingFileKinematics,tracking_result.model_info);        % load .mot file with tracking data
