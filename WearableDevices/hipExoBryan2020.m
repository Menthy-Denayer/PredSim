...
exo.addBodyMoment(T_tot_shifted, ['T_hip_exo_pelvis_',side],[upper_body_name,'_',side]);
exo.addBodyMoment(-T_tot_shifted, ['T_hip_exo_thigh_',side],[lower_body_name,'_',side],[upper_body_name,'_',side]);
